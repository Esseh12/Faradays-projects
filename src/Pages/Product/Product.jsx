...
const ProductPage = () => {
	...
	const products = [
		...
		},
		{
			...
			price: 1199.99,
			rating: 4.5,
			image: '/images/products/inverter-2.jpg',
			specs: {
				power: '3kW',
				efficiency: '97.5%',
				warranty: '8 Years',
		...
		},
		{
			...
			specs: {
				material: 'Aluminum',
				warranty: '15 Years',
				compatibility: 'All SolarTech Panels',
		...
		},
		{
			...
			price: 3299.99,
			rating: 4.5,
			image: '/images/products/battery-2.jpg',
			specs: {
				capacity: '5kWh',
				cycles: '4000+',
				warranty: '10 Years',
			...
			<section className='product-hero'>
				<Container>
					<motion.div
						...
						<p>
							Explore our high-efficiency solar panels, powerful inverters, and
